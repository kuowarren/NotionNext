...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '戶外邊緣人，平凡到不行的工程師，想要成為大大，所以在成為大大的路上努力中。',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Warren Kuo', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '路人工程師戶外人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.instagram.com/warren.kuo/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Waren Kuo', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'warren7807@hotmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || 'https://www.instagram.com/warren.kuo/', // 您的instagram地址
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Warren Kuo BLOG', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '戶外邊緣人，平凡到不行的工程師，想要成為大大，所以在成為大大的路上努力中。', // 站点描述，被notion中的页面描述覆盖
